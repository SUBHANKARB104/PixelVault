...
from minio_client import ensure_bucket, upload_file, delete_file
...
app = FastAPI(
    ...
    description="Secure image storage with JWT auth, MinIO, and PostgreSQL",
    version="1.0.0",
)
...
def on_startup():
    """Make sure the MinIO bucket exists when the server starts."""
    ensure_bucket()
